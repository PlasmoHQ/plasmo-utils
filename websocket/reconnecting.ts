 ...
 * Forked from https://github.com/pladaria/reconnecting-websocket
 * MIT License
 */
...
export type ListenersMap = {
  [key in keyof Events.WebSocketEventListenerMap]: Array<
    Events.WebSocketEventListenerMap[key]
  >
}
...
export class ReconnectingWebSocket {
   ...
   */
  public onclose?: (event: Events.CloseEvent) => void

  /**
   * An event listener to be called when an error occurs
   */
  public onerror?: (event: Events.ErrorEvent) => void
